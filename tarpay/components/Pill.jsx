...
const M = {
  ON_HOLD:{l:"On Hold",c:"#FF9F43"}, SETTLED:{l:"Settled",c:"#00F5B4"},
  REVERTED:{l:"Reverted",c:"#3D9EFF"}, DISPUTED:{l:"Disputed",c:"#FF4567"},
  FLAGGED:{l:"Flagged",c:"#FF4567"}, CANCELLED:{l:"Cancelled",c:"#6E6E8A"},
