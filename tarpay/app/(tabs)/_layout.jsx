...
const s = StyleSheet.create({
  ...
  dot:      { width:4, height:4, borderRadius:2, backgroundColor:MINT },
  sendBtn:  { width:50, height:50, borderRadius:25, alignItems:"center", justifyContent:"center", shadowColor:MINT, shadowOffset:{width:0,height:4}, shadowOpacity:0.5, shadowRadius:12, elevation:10 },
});